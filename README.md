...
| [SP500-lstm-portfolio](https://github.com/xenaxu7/SP500-lstm-portfolio) | Walk-forward LSTM stock selection on 479 S&P 500 names: monthly re-ranking with six-monthly retraining, 5/20 bps costs, equal-weight, momentum and SPY benchmarks, point-in-time universe filter, information coefficient and a 500-draw random-basket test. The write-up shows that the headline return came from using today's constituent list, and disappears once later index additions are removed | Python, TensorFlow/Keras, pandas, yfinance |
